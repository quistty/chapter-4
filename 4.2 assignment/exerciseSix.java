...
public class exerciseSix {
    public static void main(String[] args) {
        ...
        // the printf basically makes it so it will always have 2 decimal places. To change the # of places, u would change 2 to 3. 
        // print format has many other uses, such as %d for decimal integers, %s for strings (which basically acts as a placeholder for variables)
